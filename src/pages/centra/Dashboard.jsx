          ...
          <div className="bg-quaternary text-base text-white font-montserrat">
            <div className="transparent">
              <div className="absolute top-[0px] left-[0px] bg-beige w-screen h-screen overflow-y-scroll">
                ...
                />
                <img
                  className="absolute top-[210px] left-[0px] w-[430px] h-[703px]"
                  alt=""
                  src={"src/assets/dashboard/rectangle-3.svg"}
                />
                <div className="absolute top-[325px] ml-6 rounded-full text-xs text-black bg-white w-[370px] h-[47px]">
                  <ul className="flex items-center">
                      <li className="flex-1 mt-2">
                        <a className="text-center block border-tertiary rounded-full py-2 px-2 hover:bg-tertiary hover:text-white" href="#">Wet Leaves</a>
                      </li>
                      <li className="flex-1 mt-2">
                        <a className="text-center block border-tertiary rounded-full py-2 px-2 hover:bg-tertiary hover:text-white" href="#">Dry Leaves</a>
                      </li>
                      <li className="flex-1 mt-2">
                        <a className="text-center block border-tertiary rounded-full py-2 px-2 hover:bg-tertiary hover:text-white" href="#">Flour</a>
                      </li>
                      <li className="flex-1 mr-1 mt-2">
                        <a className="text-center block border-tertiary rounded-full py-2 px-2 hover:bg-tertiary hover:text-white" href="#">Shipping</a>
                      </li>
                    </ul>
                </div>
                <div className="absolute top-[395px] ml-6 rounded-2xl bg-white w-[370px] h-[255px]">
                  <form className="absolute top-2 right-1 h-10 w-30">
                    <select id="times" className="bg-quaternary border border-primary text-primary text-sm focus:ring-primary focus:border-primary block w-full p-1 dark:bg-primary dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:primary dark:focus:border-primary rounded-full py-1 px-1">
                      <option>Daily</option>
                ...
                <div className="absolute top-[675px] ml-6 rounded-2xl text-sm text-black bg-white w-[370px] p-4"> 
                ...
                <div className="absolute top-[270px] left-[48px] text-mini font-extralight text-seagreen-300 text-center inline-block w-[54px] h-[15px]">
                  Search
                </div>
                
                <b className="absolute top-[810px] left-[145px] text-[30px] inline-block w-[142px] h-[33px]">
                  Collector
                </b>
                <img
